...
use crate::ontologies::{EDAM_NS, Ontology, INVALID_URI};
...
impl Ontology for Encoding {
    fn uri(&self) -> url::Url {
        let uri = EDAM_NS.to_string() + match self {
...
mod tests {
    ...
    use crate::ontologies::{Ontology, Encoding};

    #[test]
    fn test_topology_ontology() {
        let variants = [
            (Encoding::NucleicAcid, "https://identifiers.org/edam:format_1207"),
            (Encoding::Protein,     "https://identifiers.org/edam:format_1208"),
